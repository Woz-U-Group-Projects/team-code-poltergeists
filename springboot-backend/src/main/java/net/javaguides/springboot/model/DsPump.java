...
public class DsPump {
	...
	@Column(name = "f02a")
	private Boolean f02a;

	@Column(name = "f02b")
	private Boolean f02b;

	@Column(name = "f02c")
	private Boolean f02c;
	...
	public DsPump(long id, String shiftDate, String shift, String time, String operator,
			...
			Boolean f02a, Boolean f02b, Boolean f02c) {
		super();
		this.id = id;
	...
	public Boolean getF02a() {
		return f02a;
	}

	public void setF02a(Boolean f02a) {
		this.f02a = f02a;
	}

	public Boolean getF02b() {
		return f02b;
	}

	public void setF02b(Boolean f02b) {
		this.f02b = f02b;
	}

	public Boolean getF02c() {
		return f02c;
	}

	public void setF02c(Boolean f02c) {
		this.f02c = f02c;
	}
